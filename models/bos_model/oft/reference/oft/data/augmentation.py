...
def random_flip(image, calib, objects):
    ...
    for obj in objects:
        ...
        flipped_objects.append(utils.ObjectData(obj.classname, position, obj.dimensions, angle, obj.score))
...
class AugmentedObjectDataset(Dataset):
    def __init__(
        self, dataset, image_size=(1080, 360), grid_size=(160, 160), scale_range=(0.8, 1.2), jitter=[0.25, 0.5, 0.25]
    ):
